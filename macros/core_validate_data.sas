...
%macro core_validate_data(
  ...
  data _null_;
    message = core_validate_data("&cache_path", &pool_size, "&data", "&dataset_path", "&log_level", "&report_template", "&standard", "&version", "&output",  "&output_format",  &raw_report, "&controlled_terminology_package" , "&define_version", "&define_xml_path", "&whodrug", "&meddra", "&rules");
