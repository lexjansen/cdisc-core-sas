def core_update_cache(apikey, cache_path, custom_rules_directory, custom_rule, remove_custom_rules, update_custom_rule, custom_standard, custom_standard_encoding, remove_custom_standard):
    """Output: """
